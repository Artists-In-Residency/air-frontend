...
<div className="main">
    ...
    <main>
        <ul>
            <li> <h5>Rivet</h5>
                <a href="https://rivet.es/" target="_blank" rel="noopener noreferrer">https://rivet.es/</a></li> 

            <li> <h5>Arena</h5>
            <a href="https://www.are.na/shobun-baile/artist-residencies" target="_blank" rel="noopener noreferrer">https://www.are.na/shobun-baile/artist-residencies</a><br></br>
            <a href="https://www.are.na/anthony-warnick/residencies-1530303698" target="_blank" rel="noopener noreferrer">https://www.are.na/anthony-warnick/residencies-1530303698</a><br></br>
            <a href="https://www.are.na/marion-v-y/residencies-and-projects" target="_blank" rel="noopener noreferrer">https://www.are.na/marion-v-y/residencies-and-projects</a><br></br>
            <a href="https://www.are.na/zhenya-k/opportunities-for-artists-and-curators" target="_blank" rel="noopener noreferrer">https://www.are.na/zhenya-k/opportunities-for-artists-and-curators</a>

            </li>
            <li><h5>New Media Caucus</h5><a href="http://www.newmediacaucus.org/" target="_blank" rel="noopener noreferrer">http://www.newmediacaucus.org/</a> </li>
            <li> <h5>Trans Arts - (opportunity aggregator)</h5><a href="https://www.transartists.org/" target="_blank" rel="noopener noreferrer">https://www.transartists.org/</a> </li>
            <li> <h5>Creative Capital - (look for their monthly roundup)</h5> <a href="https://creative-capital.org/" target="_blank" rel="noopener noreferrer">https://creative-capital.org/</a> </li>
            <li> <h5>Alliance of Artist Communities</h5> <a href="https://www.artistcommunities.org/" target="_blank" rel="noopener noreferrer">https://www.artistcommunities.org/</a>
            </li>
            <li> <h5>Funding</h5><a href="https://candid.org/find-funding" target="_blank" rel="noopener noreferrer">https://candid.org/find-funding</a></li>
            <li> <h5>Emergency Grants</h5> <a href="https://www.foundationforcontemporaryarts.org/grants/emergency-grants" target="_blank" rel="noopener noreferrer">https://www.foundationforcontemporaryarts.org/grants/emergency-grants</a> </li>
        </ul>
        <hr></hr>
    </main>

    <h3 className="center">
    Here’s the hot art tips: 
    </h3>
    ...
    <h3 className="center">Sales/pricing:</h3><h5>Market rate (for physical work)</h5>
        <p>
    ...
    <h3 className="center">Sales/pricing:</h3> 
    <h5 className="center">(for digital work)</h5>
        <p>
        ...
        I like <a href="https://itch.io/" target="_blank" rel="noopener noreferrer">https://itch.io/</a> for this, which is oriented for games but also hosts lots of weird little digital artworks
    ...
    General money:
        ...
        <p>
        Spend as much energy developing your paying side gig as you do in the studio
        You need a flexible fallback that can travel with you, or lets you take time off - even if it’s just like, transcription or online tutoring or ghostwriting articles or the local coffee shop with a chill manager or whatever
    ...
    <h3 className="center">Taxes:</h3> <h5>(US-based)</h5>
        <p>
        ...
        (take the per diem write-off, it’s different per state: <a href="https://www.gsa.gov/travel/plan-book/per-diem-rates" target="_blank" rel="noopener noreferrer">https://www.gsa.gov/travel/plan-book/per-diem-rates</a> )
        ...
        Use the real free turbotax (freedom edition) -- > <a href="https://turbotax.intuit.com/taxfreedom/" target="_blank" rel="noopener noreferrer">https://turbotax.intuit.com/taxfreedom/</a> 
        </p>
    ...
    Proposals:
        ...
        Any renderings/shots-in progress/past related images
    ...
    Social media:
        ...
        They're bad horror show spaces but everyone is a microcelebrity in 2020
    ...
    Writing:
        ...
        Don't DM writers- find the editor or pitch line and write a succinct email
    ...
    Being a responsible artist:
        ...
        Here is me asking about the status of me on a residency wait list (that final exclamation point should really be a comma I sound kinda manic):
        </p>
        <p>
    ...
    Workspace post school:
        ...
        Think about what you can make at the kitchen table, at the library, at a coffee shop, outside
    ...
    Number one important thing:
        ...
        <p>
        So much more - <b>The Creative Independent</b> - <a href="https://thecreativeindependent.com/" target="_blank" rel="noopener noreferrer">https://thecreativeindependent.com/</a>
        </p>
